...
export class LearningStageParameterService {
     ...
     * @return {Observable<LearningStageParameter>}
     */
    getLearningStageParameterById(learningStageId: number, parameterId: number, studyId: number): Observable<LearningStageParameter> {
     ...
     * @return {Observable<LearningStageParameter>}
     */
    getLearningStageParametersByStageId(learningStageId: number, studyId: number): Observable<LearningStageParameter[]> {
     ...
     * @return {Observable<LearningStageParameter>}
     */
    createLearningStageParameter(learningStageParameter: LearningStageParameter, studyId: number): Observable<LearningStageParameter> {
     ...
     * @return {Observable<LearningStageParameter>}
     */
    updateLearningStageParameter(learningStageParameter: LearningStageParameter, studyId: number): Observable<LearningStageParameter> {
     ...
     */
    deleteLearningStageParameter(learningStageId: number, parameterId: number, studyId: number): Observable<any> {
        const url = `${this.endpoint}?learningStageId=${learningStageId}&parameterId=${parameterId}&studyId=${studyId}`;
