...
@Component({
    ...
    templateUrl: './learning-stage-parameter-assignment-form.component.html',
    styleUrls: ['./learning-stage-parameter-assignment-form.component.scss']
})
export class LearningStageParameterAssignmentFormComponent extends BaseComponent implements OnInit {
