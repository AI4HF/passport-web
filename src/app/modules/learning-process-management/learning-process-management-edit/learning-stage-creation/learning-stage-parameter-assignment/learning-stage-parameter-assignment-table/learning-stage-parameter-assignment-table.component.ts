...
@Component({
    ...
    templateUrl: './learning-stage-parameter-assignment-table.component.html',
    styleUrls: ['./learning-stage-parameter-assignment-table.component.scss']
})
export class LearningStageParameterAssignmentTableComponent extends BaseComponent implements OnInit {
